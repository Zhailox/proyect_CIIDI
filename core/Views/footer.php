<footer class="main-footer">
  <div class="footer-container">
    ...
    <div class="footer-column">
      <h3 class="footer-title"><i class="ph-fill ph-map-pin"></i> Ubícanos</h3>
      <p class="footer-text">
      ...
      <p class="footer-text" style="margin-top: 1rem;">
        <strong><i class="ph-fill ph-phone"></i> Teléfonos:</strong><br>
    ...
    <div class="footer-column">
      <h3 class="footer-title"><i class="ph-fill ph-buildings"></i> Núcleos</h3>
      <p class="footer-text" style="font-size: 0.85rem; line-height: 1.8;">
        ...
        <strong>Ext. Carache:</strong> Calle Vargas entre Av.2 y Av.3, al lado Alcaldía. Tel: 0272-999.16.05
      </p>
    </div>

    <div class="footer-column">
      <h3 class="footer-title"><i class="ph-fill ph-share-network"></i> Redes Sociales</h3>
      <ul class="footer-links">
        <li><a href="#"><i class="ph-fill ph-facebook-logo"></i> Gestión UPTTMBI</a></li>
        <li><a href="#"><i class="ph-fill ph-twitter-logo"></i> @upttmbi</a></li>
        <li><a href="#"><i class="ph-fill ph-instagram-logo"></i> @upttmbi</a></li>
  ...
  <div class="footer-bottom">
    ...
    <p>Desarrollado por PNF Informática</p>
  </div>
</footer>