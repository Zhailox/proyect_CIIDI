...
class QueryBuilder {
    ...
    public function tabla(string $nombre_tabla) {
        ...
        $this->joins = [];       // Reset de JOINs para evitar contaminación entre consultas
        $this->condiciones = [];
        $this->parametros = [];
        $this->columnas = '*';
        $this->limite = '';
    ...
    // ACTUALIZACIÓN: Le enseñamos al método get() a armar los JOINs
    public function get() {
