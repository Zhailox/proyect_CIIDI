<?php
// Obtenemos la data REAL directamente desde la memoria del Kernel
$modulosDelSistema = $this->getInfoModulosAdmin();
?>
        ...
        <div class="module-card-v2 <?= $mod['es_core'] ? 'is-core' : ($mod['estado'] === 'offline' ? 'offline-demo' : '') ?>">
            ...
            <div class="module-toggle-group mt-1">
                ...
                <?php else: ?>
                    ...
                    <?php if($mod['dependencias_count'] > 0): ?>
                        <label for="modal-warn-<?= $mod['id'] ?>" class="toggle-switch trigger-modal cursor-pointer">
                            <input type="checkbox" <?= $mod['estado'] === 'online' ? 'checked' : '' ?>> 
