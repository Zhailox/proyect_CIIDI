...
Auth::requierePrivilegioMinimo(0); // Exclusivo para Estudiantes (0) en adelante
...
// Agrupar oportunidades por trayecto y extraer líneas únicas
...
foreach ($oportunidades as $op) {
    ...
    $linea = $op['linea_investigacion'] ?: 'Sin Línea Asignada';
...
// Ordenar las columnas lógicamente
...
// Función para mapear el Trayecto a un data-nivel compatible con Investigaciones.css
